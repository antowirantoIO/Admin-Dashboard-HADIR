...
const getApi = () => {
  ...
  return (
    ...
    <React.Fragment>
      ...
      <MetaTags>
        <title>Kalender Akademik | HADIR</title>
      </MetaTags>
          ...
          <Card>
            <CardBody className="d-grid">
              ...
              <div id="external-events">
                ...
                Seret dan lepas acara Anda atau klik di kalender
                        </p>
                {categories &&
              ...
              <div className="mt-5">
                <h5 className="font-size-14 mb-4">Aktivitas Terbaru :</h5>
